...
const { Tray, Menu, nativeImage, screen, dialog, app } = electron;
let tray = null;
/**
 ...
 */
function createTray(scenarioList, runScenarioCallback, openStopwatchCallback) {
    if (tray) {
    ...
    const contextMenuTemplate = [
        ...
        },
        {
            label: '⏱️ 开启专注秒表',
            click: () => {
                if (openStopwatchCallback) openStopwatchCallback();
            }
        },
        { type: 'separator' },
